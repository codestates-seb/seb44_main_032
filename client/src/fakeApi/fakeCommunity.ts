...
//         return axios.get(`/community/getCommunityList-page${page || 1}.json`).then((res) => res.data)
//     }
//     async getCommunitySearch(search: string, page?: number) {
...
//     }
//     async getCommunityCategoryList(category: string, page?: number) {
